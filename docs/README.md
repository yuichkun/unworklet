...
| `decisions-log.md` | populated (Q1–Q62 ratify complete; Q28 is unassigned — numbering artifact, not a withheld decision; outstanding mechanical sweep tracked in `open-questions.md` Layer 4) |
