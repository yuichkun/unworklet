...
<!-- Q9 — pnpm workspaces? Turborepo? Nx? Vite+ per package? Concrete pick + rationale.
     Lands here. -->

## 2. Package layout

<!-- Q10 — initial structure: do all `@unworklet/*` packages exist from day one,
...
<!-- Q12 — license choice. Lands here. -->

## 4. npm scope

<!-- Q13 — confirm `@unworklet/*` scope availability on npm; fallback name if taken.
     Lands here. -->

## 5. TypeScript version policy

<!-- Q23 — minimum supported TS version, CI matrix, ESM-only stance. Lands here. -->

## 6. Versioning policy

<!-- semver shape, breaking-change rules, recompilation requirement on major bumps.
     (Settled enough to write up after Q9 / Q11 / Q23 land.) -->
